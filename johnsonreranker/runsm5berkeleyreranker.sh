...
# This script will run the reranker on the kbest output of the berkeley parser trained using 5 split-merge iterations

#MODELDIR=models/berkeley50spfinal
MODELDIR=models/berkeleysm5spnonfinal
...
python programs/prepare-data/parseFormatConvertor.py berkeley $* 2> "failedsentids.$pid" | programs/features/best-parses -l $MODELDIR/features.gz $MODELDIR/$ESTIMATORNICKNAME-weights.gz > "/tmp/rerankedOutput.$pid"
